    ...
    <section id="contact" className="relative py-20 bg-gradient-to-br from-gray-900 via-black to-gray-900 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="mt-3 max-w-xl mx-auto text-lg text-gray-300">
        ...
        <div className="grid gap-8 lg:grid-cols-2 max-w-4xl mx-auto">
          {/* Contact Info */}
          <div className="backdrop-blur-md bg-white/5 rounded-xl p-6 border border-white/10 shadow-xl transform transition-all hover:scale-[1.01]">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="mt-1 block w-full bg-white/5 border border-white/10 rounded-lg shadow-sm py-2 px-3 text-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200"
                    required
                  />
                ...
                <div>
                  <button
                    type="submit"
                    disabled={processing}
                    className="w-full py-2 px-4 rounded-full bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-medium text-base hover:shadow-lg hover:from-blue-600 hover:to-indigo-700 transition-all duration-300 transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed"
                  >
