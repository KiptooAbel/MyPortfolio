...
import {
    ...
    Settings, Tags, Truck, MessageSquare, Bell, Headset,
    LifeBuoy, ClipboardList, ChevronLeft, ChevronRight, Star,
  } from 'lucide-react';
...
function AuthenticatedLayout({ header, children }) {
  const user = usePage().props.auth.user;
    ...
    const navigationItems = [
        { name: 'Dashboard', href: route('projects.index'), icon: LayoutGrid }
